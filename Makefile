.PHONY: install setup_husky clean lint gas format format_check format_contract test test_contract before_commit build_frontend start build_backend build_contract export_pdf pr_diff help
